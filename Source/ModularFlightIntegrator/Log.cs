...
namespace ModularFI
{
	...
	{
		private static readonly Logger log = Logger.CreateForType<Startup>("ModularFlightIntegrator", false, 1);
		...
		internal static void error (object offended, string msg, params object [] @params)
		{
			log.error (msg, @params);
			log.stack (offended);
		}
